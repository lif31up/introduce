  ...
  return (
    <section title='stack-board' style={style} className='grid justify-items-center _bg-grid' id='stack-board'>
      <div title='heading' className='grid justify-items-center mb-16'>
        <h1 className='_text-huger _text-black-bolder'>제가 사용하는 기술이에요!</h1>
  ...
  return (
    <div className='flex justify-center items-start gap-12'>
      <div style={board} className='grid gap-8'>
        <ObservedContributor prefix='stack-board-0-' threshold={0.5} animation='_anime-vanish-in'>
          {channels[0]}
        </ObservedContributor>
      </div>
      <div style={board} className='grid gap-8'>
        <ObservedContributor prefix='stack-board-1-' threshold={0.5} animation='_anime-vanish-in'>
          {channels[1]}
        </ObservedContributor>
      </div>
      <div style={board} className='grid gap-8'>
        <ObservedContributor prefix='stack-board-2-' threshold={0.5} animation='_anime-vanish-in'>
          {channels[2]}
        </ObservedContributor>
      </div>
      <div style={board} className='grid gap-8'>
        <ObservedContributor prefix='stack-board-3-' threshold={0.5} animation='_anime-vanish-in'>
          {channels[3]}
        </ObservedContributor>
      </div>
    </div>
