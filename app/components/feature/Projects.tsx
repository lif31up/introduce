...
export default function Projects({}){
	...
	<AnimationContainerTable id={"project--0"} animation={"custom-anime-rtl-slide"}>
		<Project h1={"무한 스크롤링"}
						 ...
						 src={"/assets/images/shoppingmall.webp"} imageId={"project--0--img-0"}
		...
		<Project h1={"포트폴리오"}
						 ...
						 src={"/assets/images/portfolio.webp"} imageId={"project--0--img-1"}
		...
		<Project h1={"뉴럴링크"}
						 ...
						 src={"/assets/images/neuralink.webp"} imageId={"project--0--img-2"}
		...
		<Project h1={"자료구조"}
						 ...
						 src={"/assets/images/data_structure.webp"} imageId={"project--0--img-3"}
		...
		<Project h1={"웹 디자인 블로그"}
						 ...
						 src={"/assets/images/web_design_blog.webp"} imageId={"project--0--img-4"}
		...
		<Project h1={"로고 디자인"}
						 ...
						 src={"/assets/images/logo_design.webp"} imageId={"project--0--img-5"}
