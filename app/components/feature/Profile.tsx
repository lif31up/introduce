	...
	<div className={["_gray_content p-4 flex",desktop ? "custom-mobile-disable":"custom-desktop-disable"].join(" ").trim()}>
		...
		<div className={"pl-4 pt-1"}>
			<div className={"flex items-end"}>
				...
				<p className={"custom-font-gothic-a1-thin text-neutral-300 ml-2"}>{"연세대학교"}<abbr className={"text-white"}>{" 정보통신학과 "}</abbr></p>
			</div>
			...
			<div className={"flex gap-2 mt-1 text-purple-400 custom-font-gothic-a1-thin underline"}>
