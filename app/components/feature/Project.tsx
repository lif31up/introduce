		...
		<div className={"_content"}>
			<div className={"p-4 text-white custom-font-gothic-a1"}>
				...
				<Image src={src} alt={"project_img"}
							 width={"1"} height={"1"} sizes={"230px"} loading={"lazy"}
							 className={"w-full h-60 rounded-2xl overflow-hidden object-contain object-center"}/>
				<p className={"custom-font-gothic-a1-thin mt-4 leading-7 tracking-wide"}>{p}</p>
			</div>
		</div>
	</a>
	);
