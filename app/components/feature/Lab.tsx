...
export default function Lab({}) {
  return (
    <AnimateSetter id={'quotes--0'} animation={'custom-anime-swash-in'}>
      <Quote
        src={'/assets/images/neal_stephenson.jpg'}
        h1={'Snow Crash'}
        p={
      ...
      />
      <Quote
        src={'/assets/images/william_gibson.webp'}
        h1={'Neuromancer'}
        p={
      ...
      />
      <Quote
        src={'/assets/images/j_g_ballard.jpg'}
        h1={'The Drowned World'}
        p={
