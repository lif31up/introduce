        ...
        <div className={'_grid-2xl-article'}>
          ...
          <StackTable id={'st--0'}>
            {[
              {
                h1: '자바스크립트',
                p: 'DOM 조작과 자체 API, 약속체, 상속과 메소드에 대해 정확한 지식을 가지고 있습니다.',
                src: '/assets/images/javascript_icon.webp',
              },
              {
                h1: '타입스크립트',
                p: '엄격한 문법도 막힘없이 읽어 확장, 작성할 수 있습니다.',
                src: '/assets/images/typescript_icon.webp',
              },
              {
                h1: 'SASS',
                p: 'SASS를 통해 반응형 스타일시트를 만드는데 도가 텄습니다.',
          ...
          <StackTable id={'st--1'}>
            {[
              {
                h1: '넥스트',
                p: 'CSR 및 SSR 패턴화, 라우팅, 이미지 최적화 등을 사용할 줄 압니다.',
                src: '/assets/images/next_icon.webp',
              },
              {
                h1: '리액트',
                p: '후크, 상태를 모두 이해하고 있습니다. 리액트 쿼리, 리코일에도 이미 익숙합니다.',
                src: '/assets/images/react_icon.webp',
              },
              {
                h1: '버셀',
                p: '이 페이지도 버셀을 통해 배포되는 중입니다. 이를 통해 프로토타입을 테스트할 수 있습니다.',
          ...
          <StackTable id={'st--2'}>
            {[
              {
                h1: '포토샵',
                p: '포토샵을 통해서 목업과 이미지에 대한 필터 효과를 적용할 수 있습니다.',
                src: '/assets/images/photoshop.webp',
              },
              {
                h1: '일러스트레이터',
                p: '가장 자신있게 다루는 디자인 도구입니다. 로고, 아이콘, 일러스트를 만들 수 있습니다.',
                src: '/assets/images/illustrator.webp',
              },
              {
                h1: 'XD',
                p: 'UI/UX를 디자인하기 위해 주로 사용하는 도구입니다.',
                src: '/assets/images/xd.webp',
              },
            ]}
          </StackTable>
          <div className={'_trans_content pt-2'}>
            <h1 className={'text-3xl custom-font-gothic-a1'}>
              {'소프트 스킬'}
            </h1>
          </div>
          <StackTable id={'st--3'}>
            {[
              {
                h1: '학습',
                p: '새로운 지식을 습득할 때, 재미를 느낍니다. 최신 정보를 찾아보는데 주저함이 없습니다.',
                src: '/assets/images/coworking_informative.webp',
              },
              {
                h1: '의사소통',
                p: '사람들과 협업하는 것을 즐깁니다. 새로운 사람을 만나고 대화 나누는데 흥미가 많습니다.',
                src: '/assets/images/coworking_communicative.webp',
              },
              {
                h1: '문제해결',
                p: '문제를 해결하고 풀어나갈 때, 과업을 온전히 책임을 지고 있다고 느낍니다.',
