    ...
    <main>
      ...
      <div className={'_grid-2xn'} id={'content--0'}>
        <div className={'_grid-n'}>
          ...
          <div className={'_grid-content-complex _bg-black-045 _rounded-1xl overflow-hidden _dynamic-sm'} id={'front-end'}>
            ...
            <AnimateSetter id={'stack-table--1'} animation={'_slide-rtl'} gap={'_gap-05'}>
              <Stack
                ...
                title={'자바스크립트'}
                desc={
                  'DOM 조작과 자체 API, 약속체, 상속에 대해 정확한 지식을 가지고 있습니다. ES6 문법을 주로 사용했고 이에 익숙합니다.'
                }
              />
              <Stack
                ...
                title={'타입스크립트'}
                desc={
                  '엄격한 문법도 막힘없이 읽어 확장, 작성할 수 있습니다. 리액트와 같이 사용한 경험이 많아 디버깅에 유리합니다.'
                }
              />
              <Stack
                ...
                title={'SASS'}
                desc={
                  'SASS를 통해 반응형 스타일시트를 만들 수 있습니다. 그 외에도 컴파일 방식이나 코드 캡슐화를 읽고 쓸 줄 압니다.'
                }
              />
              <Stack
                ...
                title={'넥스트'}
                desc={
                  'CSR 및 SSR 패턴화, 라우팅, 이미지 최적화 등을 사용할 줄 압니다. 전반적인 이해를 가지고 있다고 믿으셔도 됩니다.'
                }
              />
              <Stack
                ...
                title={'리액트'}
                desc={
                  '후크, 상태를 이해하고 적용할 줄 압니다. 리액트 쿼리, 리코일에도 익숙합니다. 이 부분은 제가 자신하는 제 강점입니다.'
                }
              />
              <Stack
          ...
          <div className={'_grid-content-complex _bg-black-045 _rounded-1xl overflow-hidden _dynamic-sm'} id={'design'}>
            ...
            <AnimateSetter id={'stack-table--3'} animation={'_slide-rtl'} gap={'_gap-05'}>
              ...
              <Stack
                ...
                title={'포토샵'}
                desc={
                  '포토샵을 통해서 목업과 이미지에 대한 필터 효과를 적용할 수 있습니다. 전반적인 보정 작업에 대한 틀을 잡을 줄 앎니다.'
                }
              />
              <Stack
          ...
          <div className={'_grid-content-complex _bg-black-045 _rounded-1xl overflow-hidden'}>
            ...
            <AnimateSetter id={'stack-table--4'} animation={'_slide-rtl'} gap={'_gap-05'}>
              <Stack
                ...
                title={'호기심'}
                desc={'새로운 지식 또는 이야기를 습득할 때, 재미와 열정을 느낍니다. 그만큼 저도 많은 걸 알고 있습니다.'}
              />
              <Stack
                src={'/assets/images/coworking_communicative.webp'}
                title={'의사소통'}
                desc={'사람들과 협업하는 것을 즐깁니다. 새로운 사람을 만나서 그들의 이야기를 듣는 걸 재밌어합니다 ^^'}
              />
              <Stack
                src={'/assets/images/coworking_problemsolver.webp'}
                title={'문제해결'}
                desc={
                  '문제를 해결하고 풀어나갈 때, 과업을 온전히 책임을 지고 있다고 느낍니다. 장애물이 생겼을 때, 열정이 더 생깁니다.'
                }
              />
            </AnimateSetter>
          </div>
        ...
        <div className={'_grid-n'} id={'grid-n-1'}>
          ...
          <div id={'project'} className={'_dynamic-sm'}>
            <div className={'_grid-content _desktop_disable mt-8'}>
              <h1 className={'_heading_huge text-white'}>프로젝트</h1>
              <p className={'_text-regular text-neutral-400'}>
                제가 지금까지 진행해온 프로젝트입니다. 하나하나 모두 의미있는 경험이었습니다.
              </p>
            </div>
            <AnimateSetter id={'projects--0'} animation={'_swash-in'} gap={'_dynamic-gap'}>
              <Project
                h1={'무한 스크롤링'}
                p={
                ...
                tags={['REACT QUERY', 'OBSERVER API', 'FETCHING']}
              />
              <Project
                h1={'포트폴리오'}
                p={
                ...
                tags={['REACT', 'NEXT', 'VERCEL', 'FIREBASE API', 'SCSS', 'TAILWIND CSS']}
              />
              <Project
                h1={'뉴럴링크'}
                p={
                ...
                tags={['SCSS', 'TAILWIND CSS', 'NEXT', 'XD']}
              />
              <Project
                h1={'자료구조'}
                p={
                ...
                tags={['C LANGUAGE', 'BASIC', 'COMPUTER SCIENCE']}
              />
              <Project
                h1={'웹 디자인 블로그'}
                p={
                ...
                tags={['GITBOOT', 'UI/UX DESIGN', 'DESIGN THEORY']}
              />
              <Project
                h1={'로고 디자인'}
                p={
                  '제가 직접 만든 로고 디자인입니다. 이를 통해서 여러 이론이 적용된 로고를 만들 수 있게 되었습니다. 직접 드로윙해서 일러스트레이터로 SVG화 한 것입니다.'
                }
              ...
              <Project
                h1={'멀티 블로그 (팀 프로젝트)'}
                p={
                  '현재 제가 수행하고 있는 팀 프로젝트입니다. 캠퍼스픽이라는 어플을 통해서 각 분야의 학생이 모여서 블로그 서비스를 제작 중입니다. 현재까지 이는 아직 진행 중입니다. 클릭해서 UI/UX와 디자인 체계 설계 과정을 볼 수 있습니다.'
                }
                href={'https://www.figma.com/file/QdBfYwopNqZeLVheCN4eam/Design-System?type=whiteboard&node-id=0-1'}
                tags={['FIGMA', 'SLACK']}
              />
            </AnimateSetter>
          </div>
          <div className={'_grid-content _desktop_disable mt-8'}>
            ...
            <p className={'_text-regular text-neutral-400'}>
              현재 진행 중인 프로젝트입니다. 제가 현재 어떤 방향성을 가지고 있는 지를 나타내기 위함입니다.
            </p>
          </div>
          <WorkingOnTable />
        </div>
